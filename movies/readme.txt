...
This was a series of challenges to answer the questions shown below. 
You can do the game yourself by starting with sqlite3 movies.db
From here you can .schema TABLE_NAME or .tables just get an idea of the entire scenario.

Otherwise you can go straight through each .sql where you can see my answers (sql commands)
